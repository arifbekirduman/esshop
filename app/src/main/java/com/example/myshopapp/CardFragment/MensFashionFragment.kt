...
class MensFashionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_mens_fashion, container, false)
        ...
        view.recyclerViewMensFashion.layoutManager = GridLayoutManager(requireContext(),2,GridLayoutManager.VERTICAL,false)
